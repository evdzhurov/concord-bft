...
class DropPrePreparesNoViewChangeStrategy : public IByzantineStrategy {
 public:
  ...
  explicit DropPrePreparesNoViewChangeStrategy(logging::Logger& logger) : logger_(logger) {}
  virtual ~DropPrePreparesNoViewChangeStrategy() override {}
